	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false, ?isDebug:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'tricky':
				...
				addOffset("idle", 0, -75);
				addOffset("singUP", 3, -86);
				addOffset("singRIGHT", 46, -177);
				addOffset("singLEFT", 53, -72);
				addOffset("singDOWN", -11, -94);
			...
			case 'trickyMask':
				...
				addOffset("singUP", 63, -110);
				addOffset("singRIGHT", 82, -174);
				addOffset("singLEFT", 164, -85);
				addOffset("singDOWN", 40, -155);
			...
			case 'exTricky':
				...
				addOffset('idle');
				addOffset('Hank', -30, 60);
				addOffset("singUP", 0, 130);
				addOffset("singRIGHT", -329,-29);
				addOffset("singLEFT",177,90);
				addOffset("singDOWN",-100,-300);
